...
pscp -pw w38t35t! "\\cpl-circserv\SHINY\Circ Shiny Dashboard\Data\CPLCircShinyDashboardData\CPL Circ Data.parquet" "ibranch@sat.cantonpl.org:/var/www/html/shiny" >> Logs\%FILENAME%.log 2>&1
